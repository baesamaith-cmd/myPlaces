...
const translations = {
  ...
  en: {
    ...
    heroSubtitle: 'Upload a screenshot → read the text → check the address → save',
    stepFlowAriaLabel: '4-step place save flow',
    step1Title: '1. Image Upload',
    step1Action: '1. Image Upload',
    step2Title: '2. OCR',
    step2Action: '2. Run OCR',
    step3Title: '3. Check Address',
    step3Action: '3. Check Address',
    step4Title: '4. Save',
    ...
    ocrSuccess: 'OCR is done. Check the fields, then tap step 3 to check the address.',
